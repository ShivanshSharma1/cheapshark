    ...
    <tr style={{ padding: '0px' }}>
      <td style={{ width: '37%', padding: '0px', paddingBottom: '0px' }}>
        <td
          ...
          <Img alt="404" src={game.thumb} class="img-fluid" style={{ padding: '0px' }} />
        </td>
...
const AllGames = ({ games }) => {
  ...
  return <Fragment><div style={{ width: '80%', backgroundColor: 'black', position: 'relative', left: '9%', border: '25px solid grey', borderRadius: '25px' }}><table class="table table-border" style={{ width: '100%' }}><Headers /><tbody>{games ? games.map(g => <Game game={g} />) : <div></div>}</tbody></table></div></Fragment>
}
